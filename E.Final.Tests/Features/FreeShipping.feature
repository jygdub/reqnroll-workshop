...
Scenario: Customer with less than 20 euros of products pays for shipping
    Given the customer adds 'Apples' to their shopping cart
    And the customer adds 'Bananas' to their shopping cart
    When the customer checks out their shopping cart
    Then the total price of the order is '€4,98'
...
Scenario Outline: Order containing Furnature does not get free shipping
